...
import { DynamicPage } from '../test/pages/DynamicFieldSettingsPage';
import { ClientModalPage } from '../test/pages/DynamicFieldClientModel';
...
export class BugFinder extends World {
    ...
    Addclient!:Addclient;
    dynamicFieldSettingsPage!: DynamicPage;
    clientmodelPage!: ClientModalPage;
}
